...
Rather this exception is used to indicate when an DIVIDE OPERATION
 ...
 */
public class ProcessDivideException extends Exception {
    private int leftVal;
    private int rightVal;

    public ProcessDivideException(int leftVal, int rightVal) {
