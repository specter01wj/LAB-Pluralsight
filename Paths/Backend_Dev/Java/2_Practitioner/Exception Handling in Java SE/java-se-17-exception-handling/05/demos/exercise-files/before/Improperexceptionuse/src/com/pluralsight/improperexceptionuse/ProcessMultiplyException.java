...
Rather this exception is used to indicate when an MULTIPLY OPERATION
 ...
 */
public class ProcessMultiplyException extends Exception {
    private int leftVal;
    private int rightVal;

    public ProcessMultiplyException(int leftVal, int rightVal) {
