...
public class MyApp {
    ...
    public static void main(String[] args) {
        ...
        var totalDiscount = service.calculateTotalDiscount(order);
        System.out.println("Total discount: " + totalDiscount);

        var hasBigSale = service.hasSaleWithAmountGreaterThan(order, new BigDecimal("5.00"));
        System.out.println("Has sale greater than $5.00? " + hasBigSale);
    }
