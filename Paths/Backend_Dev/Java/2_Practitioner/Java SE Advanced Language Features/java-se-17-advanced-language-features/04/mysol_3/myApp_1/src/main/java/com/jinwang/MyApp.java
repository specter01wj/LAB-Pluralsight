...
public class MyApp {
    ...
    public static void main(String[] args) {
        ...
        var total1 = service.calculateTotalAmount(order);
        var total2 = service.calculateTotalAmount2(order);

        System.out.println("Total amount (switch statement): " + total1);
        System.out.println("Total amount (switch expression): " + total2);
    }
