...
public class MyApp {
    ...
    public static void main(String[] args) {
        ...
        var order = new Order(200201L, customer, LocalDateTime.now(), List.of(
                new SaleOrderLine(product1, 1, new BigDecimal("0.99")),
                new SaleOrderLine(product2, 3, new BigDecimal("7.50")),
        ...
        var shippingLabel = service.formatShippingAddress(customer);
        System.out.println("\nShipping address:\n" + shippingLabel);
    }
