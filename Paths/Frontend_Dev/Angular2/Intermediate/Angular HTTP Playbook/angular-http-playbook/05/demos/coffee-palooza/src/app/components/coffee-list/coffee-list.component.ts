...
import { Observable, Subject, debounceTime, distinctUntilChanged, map, of, switchMap, tap } from 'rxjs';
...
export class CoffeeListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.searchCoffee$ = this.coffeeSearchId$.pipe(
      // Comment the following two lines and use the search input to see how switchMap can cancel previous requests
      debounceTime(300),
